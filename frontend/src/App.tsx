      ...
      <div className="app-shell">
        <aside className="sidebar">
          ...
          <div className="sidebar-links">
            ...
            <a href="https://etf-live-trading.pages.dev" target="_blank" rel="noopener noreferrer" className="nav-link-ext">
            ...
            <a href="https://alphamath-teacher-os.pages.dev" target="_blank" rel="noopener noreferrer" className="nav-link-ext">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
              AlphaMath 教学
            </a>
          </div>
